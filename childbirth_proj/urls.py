...
urlpatterns = [
    ...
    path('user-notifications/clear', user_views.user_clear_notifications, name='user_clear_notifications'),
    ...
    path('user-appointments/booked-slots', user_views.user_appointment_booked_slots, name='user_appointment_booked_slots'),
