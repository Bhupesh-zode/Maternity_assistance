(function () {
  ...
  Chart.defaults.font.family = '"Exo 2", "Roboto", sans-serif';
  ...
  function buildCharts() {
    ...
    if (data.has_activity) {
      ...
      var fillStart = isDarkTheme() ? 'rgba(143, 174, 212, 0.24)' : 'rgba(34, 58, 102, 0.2)';
      var fillEnd = isDarkTheme() ? 'rgba(143, 174, 212, 0.02)' : 'rgba(34, 58, 102, 0.01)';
